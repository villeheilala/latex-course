...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Miksi \LaTeX{}?}
\begin{itemize}
\item Sen avulla voidaan tehdä hienoja dokumentteja
\begin{itemize}
\item Erityisesti matematiikassa
\end{itemize}
%
\item Se on tehty tieteentekijöiden tarpeisiin
\begin{itemize}
\item Laaja ja aktiivinen yhteisö
\end{itemize}
%
\item Se on tehokas ja laajennettavissa
\begin{itemize}
\item Lisäosia artikkelin kirjoittamiseen, esityksiin, taulukoihin, \ldots
\end{itemize}
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Kuinka se toimii?}
\begin{itemize}
\item Teksti kirjoitetaan \texttt{selkotekstinä} (engl. plain text). Tekstin
merkitys ja rakenne merkitään käyttämällä \cmd{komentoja}.
\item \texttt{latex}-ohjelma muotoilee dokumentin tekstin ja komentojen
perusteella.
\end{itemize}
\vskip 2ex
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Lisää komentoja ja niiden tulosteita\ldots}
\begin{exampletwoup}
\begin{itemize}
\item Tea
\item Milk
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Asenteen muutos}

\begin{itemize}
\item Käytä komentoja kuvaamaan sisällön merkitystä ulkoasun sijaan.
\item Keskity sisältöön.
\item Anna \LaTeX{}in tehdä loput.
\end{itemize}
\end{frame}
